...
class Fix8(QMainWindow):
    ...
    def initUI(self):
        ...
        self.leftBar.addWidget(manageFiles)
        ...
        t = threading.Thread(target=doAction, daemon=True)
        t.start()
        ...
        self.nextButtonBottom = QPushButton('Next', self)
        bottomButtons.addWidget(self.nextButtonBottom)
        # abovebottomButtons.addWidget(self.btn)
        abovebottomButtons.addWidget(self.progressBar)
        self.nextButtonBottom.clicked.connect(doAction)
