...
class Ui_Main_Window(QMainWindow, QtStyleTools):
    def __init__(self, fix8):
        ...
        self.setWindowIcon(QIcon(Fix8.resourcePath(Fix8, ".images/icon.ico")))
        self.init_UI()
        self.apply_stylesheet(self, Fix8.resourcePath(Fix8, 'my_theme.xml'))
    ...
    def init_UI(self):
        ...
        # add actions
        self.new_file_action = QAction(QIcon(Fix8.resourcePath(Fix8, ".images/open.png")), "Open Trial Folder", self)
        ...
        action.triggered.connect(lambda _, theme='Default': self.apply_stylesheet(self, Fix8.resourcePath(Fix8, 'my_theme.xml')))
