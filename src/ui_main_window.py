...
class Ui_Main_Window(QMainWindow, QtStyleTools):
    ...
    def init_UI(self):
        ...
        self.checkbox_show_aoi.stateChanged.connect(self.fix8.show_aoi)
        ...
        self.checkbox_show_fixations.stateChanged.connect(self.fix8.show_fixations)
        self.toggle_fixation_opacity.valueChanged.connect(self.fix8.fixation_opacity_changed)
        self.checkbox_show_saccades.stateChanged.connect(self.fix8.show_saccades)
